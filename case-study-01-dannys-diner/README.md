...
from membership
```
Finally, for reusablitiy, I have created a view for the final table create and the query for the same is below:

Something important to learn here was views do not work with CTEs, so we had to write it in subquery form.
